...
API_ID = int(environ.get('API_ID', '24503270'))
API_HASH = environ.get('API_HASH', '53b04d58c085c3136ceda8036ee9a1da')
BOT_TOKEN = environ.get('BOT_TOKEN', "")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))
PICS = (environ.get('PICS', 'https://telegra.ph/file/c813ac7d0ce4957f1ecaf.jpg')).split() #SAMPLE PIC
...
BOT_USERNAME = environ.get("BOT_USERNAME", "AI_Movie_Finder_bot")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002169417965') #Channel / Group Id for force sub ( make sure bot is admin )
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '7518271599') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002191764052') # request channel id ( make sure bot is admin )
...
#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '-1002191764052').split()]
TEXT = environ.get("APPROVED_WELCOME_TEXT", "<b>{mention},\n\nʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ {title} ɪs ᴀᴘᴘʀᴏᴠᴇᴅ.\n\‣ ᴘᴏᴡᴇʀᴇᴅ ʙʏ @backup899</b>")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002152214136')) #Log channel id ( make sure bot is admin )
...
URL = "loose-maure-sayandip-38b4cf71.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "loose-maure-sayandip-38b4cf71.koyeb.app/".format(FQDN, PORT)
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002152214136'))
